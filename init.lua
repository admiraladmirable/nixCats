...
Unless you want the lzUtils file, or the lazy wrapper, you also won't need lua/nixCatsUtils
...
Of course, if you only ever download nvim with nix, this isn't needed.]]
--[[ ----------------------------------- ]]
...
-- OK, again, that isn't needed if you load this setup via nix, but it is an option.
...
that's pretty much everything specific to nixCats that
...
--[[
ok that's enough for 1 file. Off to lua/myLuaConf/init.lua
